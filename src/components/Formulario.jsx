...
const Formulario = () => {
  ...
  return (
    <section id="contato" className="py-24 px-6 bg-rose-300">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <form onSubmit={enviar} className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <button className="bg-stone-950 text-white px-7 py-3 rounded-full font-semibold hover:bg-rose-700 transition-colors">
            Cadastrar
            </button>
        </form>
