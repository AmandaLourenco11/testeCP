    ...
    <section id="depoimentos" className="py-24 px-6 bg-stone-900 text-white">      <div className="max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {depoimentos.map(([nome, texto]) => (
          <blockquote key={nome} className="bg-rose-50/10 rounded-2xl p-6">              <p className="text-white mb-4">"{texto}"</p>
            <footer className="text-rose-800 font-semibold text-sm">{nome}</footer>            </blockquote>
        ))}
      </div>
    </div>
    </section>
